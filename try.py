...
class Deductions:
    def _init_(self, life_insurance: int, house_loan_interest: int, house_rent: int):
...
class EmployeeFamily:
    def _init_(self, is_married: bool, is_single: bool, is_divorce: bool, children: int):
...
class EmployeeBonus:
    def _init_(self, employee_income: int):
...
class EmployeeIncome:
    def _init_(self, employee_income: int, life_insurance: int, child_education_allowance: int, rent_allowance: int, medical_allowance: int, other_allowance: int, spouse_income: int, house_loan_interest: int, house_rent: int, deductions: Deductions):
        self.employee_income = employee_income
        self.life_insurance = life_insurance
